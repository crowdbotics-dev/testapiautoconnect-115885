...
## Project Structure
    ...
    ├── testapiautoconnect_115885  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_115885`
...
2. Clone this repo and `cd testapiautoconnect_115885`
